    ...
    <div className="container">
      ...
      <div className="row">
        ...
        <p>
          ...
          e de placa única, projetada com um microcontrolador Atmel AVR com
        ...
        <p>
          ...
          partir de software em um computador (ou smartphone / tablet, etc.). O
          protocolo pode ser implementado em firmware em qualquer arquitetura de
          microcontrolador, bem como software em qualquer pacote de software de
          computador.
        </p>
        ...
        <p>
          ...
          "Matz" Matsumoto, para ser usada como linguagem de script.
        </p>
        ...
        <ul>
          ...
          <li>
            A mandar ações à serem executadas pelo arduino através da linguagem
            ruby.
          </li>
        </ul>
      </div>
